...
- Garreau, D., & von Luxburg, U. (2020). [Explaining the Explainer: A First Theoretical Analysis of LIME](https://proceedings.mlr.press/v108/garreau20a.html). *AISTATS 2020*. (The theoretical analysis of tabular LIME. The specific large-bandwidth result verified above is in the companion paper, [*Looking Deeper into Tabular LIME*](https://arxiv.org/abs/2008.11092), §3.2.3.)
